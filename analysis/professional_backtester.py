...
class AdvancedBacktester:
    ...
    def _load_from_cache(self) -> Optional[pd.DataFrame]:
        ...
        cache_real_paths = [
            os.path.join(os.path.dirname(__file__), '..', 'src', 'cache_real', f'{symbol_clean}_{timeframe}.json'),
            os.path.join(os.path.dirname(__file__), '..', 'src', 'cache_real', f'{self.symbol}_{timeframe}.json'),
            # Fallback a formato antiguo
            os.path.join(os.path.dirname(__file__), '..', 'backtesting', 'cache', f'coin_{self.symbol.lower().replace("/", "").replace(":", "")}.json'),
            os.path.join(os.path.dirname(__file__), '..', 'src', 'cache', f'coin_{self.symbol.lower().replace("/", "").replace(":", "")}.json')
        ]
